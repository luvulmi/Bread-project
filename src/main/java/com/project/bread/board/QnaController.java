...
public class QnaController {
    private com.project.mealbong.board.QnaService qnaService;
    ...
    public String inquiry_postForm(com.project.mealbong.board.QnaDTO dto, HttpSession session, HttpServletRequest request) {
    ...
    public String qna_check(com.project.mealbong.board.QnaDTO dto) {
        if (dto != null) {
            return "insert";
        } else {
            return "fail";
    ...
    public String inquiry_getUpdate(com.project.mealbong.board.QnaDTO dto, Model model) {
        com.project.mealbong.board.QnaDTO detail = qnaService.detail(dto);
        model.addAttribute("qnaList", detail);
        return "html/service_page/inquiry/inquiry_update";
    }

    @PostMapping("/qnaupdate")
    public String inquiry_postUpdate(com.project.mealbong.board.QnaDTO dto, Model model, RedirectAttributes rttr) {
        String uri = "redirect:/qna/qnalist";
    ...
    public String inquiry_delete(@RequestParam("qna_num") int qna_num, com.project.mealbong.board.QnaDTO dto) {
