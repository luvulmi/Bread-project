...
public interface User1Service {
    int user_save(com.project.mealbong.user.User1MapperDTO user1MapperDTO);

    List<com.project.mealbong.user.User1MapperDTO> user_list();

    int user_delete(String user_id);

    com.project.mealbong.user.User1MapperDTO find_id(String user_id);

    int user_update(com.project.mealbong.user.User1MapperDTO user1MapperDTO);
...
//    ============추가한거
    ...
    // admin page
    List<com.project.mealbong.user.User1MapperDTO> searchList(SearchCriteria cri);
