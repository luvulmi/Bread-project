...
public class User1Controller {
    ...
    @Resource
    private com.project.mealbong.user.User1Service us;
...
//    **-------- 회원가입
    ...
    @PostMapping("/save")
    public ModelAndView save(@ModelAttribute com.project.mealbong.user.User1MapperDTO user1MapperDTO, DeliveryDTO deliveryDTO) throws Exception {
        ModelAndView mav = new ModelAndView();
...
//    **-------- 회원정보 수정
    ...
    @GetMapping("/{user_id}")
    public ModelAndView user_updateForm(com.project.mealbong.user.User1MapperDTO user1MapperDTO, HttpSession session, ModelAndView mav) {
...
//        }
    ...
    @PostMapping("/update")
    public ModelAndView update(ModelAndView mav, com.project.mealbong.user.User1MapperDTO user1MapperDTO, HttpSession session) {
...
//    **-------- 로그인,로그아웃
    ...
    @PostMapping("/login")
    public ModelAndView login(HttpSession session, ModelAndView mav, @ModelAttribute com.project.mealbong.user.User1MapperDTO user1MapperDTO, RedirectAttributes rttr) {
        String uri;
...
//    **-------- 어드민 관련
    ...
    public ModelAndView admin_userInfo(@PathVariable String user_id, ModelAndView mav) {
        ...
        com.project.mealbong.user.User1MapperDTO find_id = us.find_id(user_id);
    ...
    public ModelAndView admin_userDelete(com.project.mealbong.user.User1MapperDTO user1MapperDTO, ModelAndView mav) {
        String user_id = user1MapperDTO.getUser_id();
...
//    **-------- 중복체크,패스워드체크
    ...
    @ResponseBody
    public int pw_check(com.project.mealbong.user.User1MapperDTO user1MapperDTO, HttpSession session) {
    ...
    @ResponseBody
    public int login_check(com.project.mealbong.user.User1MapperDTO user1MapperDTO) {
...
//    }
    @PostMapping
    public ModelAndView user_create(com.project.mealbong.user.User1MapperDTO user1MapperDTO, ModelAndView mav) {
...
//    }
    @PutMapping
    public ModelAndView user_update2(com.project.mealbong.user.User1MapperDTO user1MapperDTO, ModelAndView mav, HttpSession session) {
